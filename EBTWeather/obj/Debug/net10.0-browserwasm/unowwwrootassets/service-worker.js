import { config as unoConfig } from "/package_9048e58c3de2629f8dd3d48fc0b89250ad1f9356/uno-config.js";
...
if (unoConfig.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('4417ee85-cbc1-4d72-929b-d6bfde11d99c').then(async function (cache) {
            ...
            caches.keys().then(function (cacheNames) {
                return Promise.all(
                    cacheNames.filter(function (cacheName) {
                        return cacheName !== '4417ee85-cbc1-4d72-929b-d6bfde11d99c';
